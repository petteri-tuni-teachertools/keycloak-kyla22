...
COPY magic-link/bin/magic-link.jar /opt/jboss/keycloak/standalone/deployments/
...
COPY themes/bin/themes.jar /opt/jboss/keycloak/standalone/deployments/
...
COPY token-validation/bin/token-validation.jar /opt/jboss/keycloak/standalone/deployments/
